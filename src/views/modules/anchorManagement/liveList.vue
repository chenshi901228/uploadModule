  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-live__liveList">
      ...
      >
        ...
        <el-form-item v-show="isOpen || formItemCount >= 9" label="是否创建预告" prop="fromPreview">
            <el-select
              clearable
        ...
        >
          <template slot-scope="{ row }">
            ...
            <el-button
              ...
              size="small"
              v-if="(row.liveState == 0 || row.liveState == 2) && $hasPermission('sys:anchorManagement:record')"
