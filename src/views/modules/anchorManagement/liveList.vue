                ...
                <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center">
                    <template slot-scope="{ row }">
                        <el-popconfirm
                            ...
                            >
                            <el-button slot="reference" type="text" size="small">下播</el-button>
                        </el-popconfirm>
                        <el-button v-if="row.liveState == 1" type="text" size="small" @click="joinLiveHandle(row.id)">进入直播间</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
