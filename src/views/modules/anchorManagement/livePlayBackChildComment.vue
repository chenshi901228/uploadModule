    ...
    <div>
        <el-card shadow="never" class="aui-card--fill">
            <div class="mod-livePlayBackComment">
                ...
                <el-descriptions style="margin:20px 0" v-if="livePlayBackCommentInfo" class="margin-top" :column="2"
                    size="small" border>
                ...
                <el-table v-loading="dataListLoading" :data="dataList" @selection-change="dataListSelectionChangeHandle"
                    ...
                    <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center"
                        ...
                        <template slot-scope="{ row }">
                            ...
                            <el-button icon="el-icon-delete" v-if="!row.delFlg && sys" type="text" size="small"
        ...
        <el-dialog top="0" custom-class="custom-dialog-top" title="回复详情" :visible.sync="commentDetailsVisible"
            ...
            <el-descriptions title="" :column="1" :labelStyle="{ width: '100px' }" :contentStyle="{ width: '80%' }">
                ...
                <el-descriptions-item label="手机号码">{{ commentDetailsInfo && commentDetailsInfo.phone || "-" }}
                </el-descriptions-item>
