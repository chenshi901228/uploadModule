        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="主播昵称" prop="anchorName">
              <el-input size="small" v-model="dataForm.anchorName" clearable></el-input>
            </el-form-item>
            <el-form-item label="真实姓名" prop="realName">
              <el-input size="small" v-model="dataForm.realName" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="身份证号" prop="idCard">
                <el-input size="small" v-model="dataForm.idCard" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
